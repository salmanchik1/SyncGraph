...
class Ui_syncGraphMainWindow(object):
    def setupUi(self, syncGraphMainWindow):
        ...
        self.gridLayout_6.addWidget(self.sensorsListView, 0, 1, 11, 1)
        ...
        self.gridLayout_3.addWidget(self.filterCheckBox, 5, 0, 1, 2)
        ...
        self.extraFUPCheckBox = QtWidgets.QCheckBox(self.groupBox_2)
        self.extraFUPCheckBox.setChecked(True)
        self.extraFUPCheckBox.setObjectName("extraFUPCheckBox")
        self.gridLayout_3.addWidget(self.extraFUPCheckBox, 6, 0, 1, 2)
        ...
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout(self.ticksGroupBox)
        ...
        self.horizontalLayout_4.addWidget(self.secondsRadioButton)
        ...
        self.horizontalLayout_4.addWidget(self.countsRadioButton)
        self.gridLayout_6.addWidget(self.ticksGroupBox, 7, 0, 1, 1)
    ...
    def retranslateUi(self, syncGraphMainWindow):
        ...
        self.groupBox_3.setTitle(_translate("syncGraphMainWindow", "Working time interval"))
        self.label_2.setText(_translate("syncGraphMainWindow", "Length of interval"))
        self.label.setText(_translate("syncGraphMainWindow", "Start of interval"))
        ...
        self.label_4.setText(_translate("syncGraphMainWindow", "Band pass START"))
        self.Fpass1Edit.setSuffix(_translate("syncGraphMainWindow", " Hz"))
        self.filterCheckBox.setText(_translate("syncGraphMainWindow", "Apply band pass filter (only for preview)"))
        self.dfEdit.setSuffix(_translate("syncGraphMainWindow", " Hz"))
        self.extraFUPCheckBox.setText(_translate("syncGraphMainWindow", "Apply narrowband filter (only for preview)"))
        ...
        self.shiftsGroupBox.setTitle(_translate("syncGraphMainWindow", "Signal sets shifts"))
