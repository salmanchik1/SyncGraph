...
class Ui_syncGraphMainWindow(object):
    def setupUi(self, syncGraphMainWindow):
        ...
        self.graphOptionsGroupBox.setMaximumSize(QtCore.QSize(16777215, 370))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 508, 133))
        ...
        self.gridLayout_5.addWidget(self.shiftsScrollArea, 0, 0, 1, 1)
