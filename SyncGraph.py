...
class Ui_syncGraphMainWindow(object):
    def setupUi(self, syncGraphMainWindow):
        ...
        syncGraphMainWindow.resize(1024, 794)
        ...
        self.dockWidget.setMinimumSize(QtCore.QSize(400, 806))
        ...
        self.gridLayout_6.addWidget(self.exportButton, 8, 0, 1, 1)
        ...
        self.modeGroupBox = QtWidgets.QGroupBox(self.dockWidgetContents)
        ...
        self.gridLayout_6.addWidget(self.sensorsListView, 0, 1, 9, 1)
    ...
    def retranslateUi(self, syncGraphMainWindow):
        ...
        self.checkBox.setText(_translate("syncGraphMainWindow", "Apply filter"))
